...
<Image src={import('./_what-is-your-skill-level.png')} alt="What is your skill level" />
...
<Image src={import('./_more-than-one-tag.png')} alt="More than one tag" />
...
<Image src={import('./_custom-field-example.png')} alt="Custom field example" />
...
<Image src={import('./_tags.png')} alt="Tags" />
...
<Image src={import('./_export-records.png')} alt="Export records" />
...
<Image src={import('./_import-csv.png')} alt="Import CSV" />

## Step 4: Import new data

Click the big Add Subscribers button, then Import a CSV.

<Image src={import('./_import-subscribers.png')} alt="Import subscribers" />
...
<Image src={import('./_map-columns-to-fields.png')} alt="Map columns to fields" />
...
<Image src={import('./_remove-tags.png')} alt="Remove tags" />
