...
<Image src={import('./_core-config-data.png')} alt="core_config_data database table" />
...
<Image src={import('./_store-website.png')} alt="store_website database table" />
...
<Image src={import('./_web-unsecure-base-url.png')} alt="web/unsecure/base_url database value" />
