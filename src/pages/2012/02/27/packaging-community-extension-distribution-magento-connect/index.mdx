...
<Image src={import('./_package-info.png')} alt="Package Info" />
...
<Image src={import('./_release-info.png')} alt="Release Info" />
...
<Image src={import('./_authors.png')} alt="Authors" />
...
<Image src={import('./_dependencies.png')} alt="Dependencies" />
...
<Image src={import('./_contents.png')} alt="Contents" />
...
<Image src={import('./_load-local-package.png')} alt="Load Local Package" />
