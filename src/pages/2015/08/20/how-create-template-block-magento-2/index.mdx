...
<Image src={import('./_how-create-template-block-magento-2.png')} alt="How to create a template block in Magento 2" />
...
```xml title=app/code/Foo/Bar/etc/module.xml
...
```php title=app/code/Foo/Bar/Block/Baz.php
<?php
...
```xml title=app/code/Foo/Bar/view/frontend/layout/cms_index_index.xml
<?xml version="1.0"?>
...
```html title=app/code/Foo/Bar/view/frontend/templates/default/baz.phtml
...
<Image src={import('./_foo-bar-baz-title.jpg')} alt="Foo bar baz title" />
