...
<Image src={import('./_deploy-magento-2-digital-ocean-tutum.png')} alt="Deploy to Tutum" />
...
<Image src={import('./_tutum-digital-ocean-confirmation.png')} alt="Digital Ocean confirmation" />
...
<Image src={import('./_tutum-deploy-first-node.png')} alt="Deploy first node" />
...
<Image src={import('./_tutum-launch-node-cluster.png')} alt="Launch node cluster" />
...
<Image src={import('./_tutum-node-cluster-deployed.png')} alt="Node cluster deployed" />
...
<Image src={import('./_digital-ocean-node-cluster-deployed.png')} alt="Digital Ocean node cluster deployed" />
...
<Image src={import('./_tutum-create-stack.png')} alt="Create stack" />
...
<Image src={import('./_tutum-deploy-stack.png')} alt="Deploy stack" />
...
<Image src={import('./_tutum-stack-deployed.png')} alt="Stack deployed" />
...
<Image src={import('./_tutum-setup-logs.png')} alt="Setup logs" />
...
<Image src={import('./_magento-2-deployed.png')} alt="Magento 2 deployed" />
...
<Image src={import('./_digital-ocean-create-record.png')} alt="Digital Ocean create record" />
...
<Image src={import('./_tutum-app-etc-env-admin.png')} alt="Tutum admin" />
...
<Image src={import('./_magento-2-web-config.png')} alt="Magento 1 web config" />
