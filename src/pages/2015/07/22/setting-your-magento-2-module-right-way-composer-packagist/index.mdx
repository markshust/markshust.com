...
<Image src={import('./_setting-up-magento-2-module-right-way-composer-packagist.png')} alt="Composer & Packagist" />
...
<Image src={import('./_packagist.png')} alt="Packagist" />
...
<Image src={import('./_composer.png')} alt="Composer" />
