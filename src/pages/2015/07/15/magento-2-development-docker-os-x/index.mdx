...
<Image src={import('./_magento-2-development-docker-os-x.png')} alt="Magento 2 Development on Docker with OS X" />
...
<Image src={import('./_elephpant.png')} alt="ElePHPant" />
...
<Image src={import('./_dinghy.png')} alt="Dinghy" />
...
> <a href="https://hub.docker.com/u/mageinferno/" target="_blank">View all Mage Inferno images at Docker Hub</a>
...
<Image src={import('./_docker-compose.jpg')} alt="Docker Composer" />
