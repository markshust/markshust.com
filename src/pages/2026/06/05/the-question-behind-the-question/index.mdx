...
Within an hour it was obvious that the theme was the least of their problems. They had over fifty modules installed; many of them overlapping, several of them touching the same things in incompatible ways. The "theme performance problem" was a symptom of an architecture that had been bolted together by someone who didn't have an architect's instinct for what *belongs* and what doesn't.
