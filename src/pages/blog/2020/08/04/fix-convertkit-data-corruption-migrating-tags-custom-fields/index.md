...
<Image src={import('./what-is-your-skill-level.png')} alt="What is your skill level" />
...
<Image src={import('./more-than-one-tag.png')} alt="More than one tag" />
...
<Image src={import('./custom-field-example.png')} alt="Custom field example" />
...
<Image src={import('./tags.png')} alt="Tags" />
...
<Image src={import('./export-records.png')} alt="Export records" />
...
<Image src={import('./import-csv.png')} alt="Import CSV" />

## Step 4: Import new data

Click the big Add Subscribers button, then Import a CSV.

<Image src={import('./import-subscribers.png')} alt="Import subscribers" />
...
<Image src={import('./map-columns-to-fields.png')} alt="Map columns to fields" />
...
<Image src={import('./remove-tags.png')} alt="Remove tags" />
