...
<code class="title">Foo/Bar/Model/Baz.php</code>
...
<code class="title">Foo/Bar/Model/ResourceModel/Baz.php</code>
...
<code class="title">Foo/Bar/Model/SomeOtherModel.php</code>
