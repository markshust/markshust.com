...
<code class="title">Foo/SecureAcceptance/registration.php</code>
...
<code class="title">Foo/SecureAcceptance/etc/module.xml</code>
...
<code class="title">Foo/SecureAcceptance/etc/di.xml</code>
...
<code class="title">Foo/SecureAcceptance/Controller/Index/PlaceOrder.php</code>
