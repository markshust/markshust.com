...
<Image src={import('./_magento-2-speed-security-permissions-docker.png')} alt="Speed security permissions & docker" />
...
<Image src={import('./_giphy.gif')} alt="Oh snap" />
...
> <a href="https://hub.docker.com/u/mageinferno/" target="_blank"><Image src={import('./_logo-tm-md.png')} alt="Mage Inferno - Docker Hub" /><br/>View all Mage Inferno images at Docker Hub</a>
