...
<Image src={import('./_computer-skillz.jpg')} alt="I've got mad computer skills" />
...
My first soirée into this is developing a curriculum and screencast course about how to <a href="https://m.academy/courses/set-up-magento-2-development-environment-docker/" target="_blank">Setup a Magento 2 Development Environment with Docker</a>.

<p>
    <a href="https://m.academy/courses/set-up-magento-2-development-environment-docker/" target="_blank">
        <Image src={import('./_magento2-docker-dev-960-740.jpg')} alt="Setup a Magento 2 Development Environment with Docker" />
    </a>
</p>
...
I have a lot of exciting courses and projects planned, and hope you can take the journey with me! I've very excited to do what I know I'm meant to be doing: teaching, helping, and educating others.
