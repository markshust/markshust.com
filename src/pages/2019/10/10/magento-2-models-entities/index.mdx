...
<Image src={import('./_goodlooking.gif')} alt="Ben Stiller really really really ridiculously good-looking" />
...
<Image src={import('./_blimp.jpg')} alt="Mark eating a blimp in Vegas" />
