...
```php title=app/code/Acme/Twilio/registration.php
<?php
...
```xml title=app/code/Acme/OrderNotifications/etc/module.xml
<?xml version="1.0"?>
...
```php title=app/code/Acme/Twilio/Observer/SendOrderNotification.php
...
```xml title=app/code/Acme/OrderNotifications/etc/events.xml
<?xml version="1.0"?>
...
<Image src={import('./_sms-result.png')} alt="SMS Result" />
