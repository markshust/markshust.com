...
```php title=Foo/SecureAcceptance/registration.php
<?php
...
```xml title=Foo/SecureAcceptance/etc/module.xml
<?xml version="1.0"?>
...
```xml title=Foo/SecureAcceptance/etc/di.xml
<?xml version="1.0"?>
...
```php title=Foo/SecureAcceptance/Controller/Index/PlaceOrder.php
<?php
