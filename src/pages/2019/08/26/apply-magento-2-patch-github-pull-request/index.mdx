...
<Image src={import('./_23656-find-replace-textedt.png')} alt="Find and replace with TextEdit" />
...
<Image src={import('./_23656-patch-log.png')} alt="Magento Cloud deployment log for 23656.patch" />
